...
import { Usb, Plus, Trash2, Shield, Monitor, RefreshCw, Smartphone, MousePointer2, HardDrive } from 'lucide-react'
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="bg-blue-500/5 border border-blue-500/20 rounded-xl p-6 relative overflow-hidden group">
        ...
        <div className="flex items-start relative z-10">
          ...
          <div>
            <h3 className="text-base font-semibold text-blue-400 mb-1">Adaptive Security Policy</h3>
            <p className="text-sm text-blue-200/70 leading-relaxed">
              Whitelisted devices are permitted even when blocking is active. Mice, keyboards, and other non-storage human interface devices are always allowed by the system kernel.
            </p>
          </div>
        </div>
      </div>
